...
import {getState, onAction, openModal, stopLoading,} from './modules/actions';

import state, {ActionOptions, setActionValue, SwalState,} from './modules/state';

import {getOpts, setDefaults, SwalOptions,} from './modules/options';
